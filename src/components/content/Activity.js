...
const Activity = ({...props}) => {
    ...
    return (
        <div style={{display:'flex', flexFlow: 'column', border: '4px solid #00467d', width: '350px', margin: '15px', borderRadius: '15px'}}>
            <div style={{ display:'flex', flexFlow:'row', justifyContent: 'space-between', padding: 10, borderBottom: '3px solid #e7eff6', background:'#00467d', color: '#FFF'}}>
            ...
            <div style={{padding: 15, fontFamily: 'monospace'}}>
                <p style={{color: '#104879', fontWeight:'bold'}}>{description}</p>
                <p style={{display: 'flex', flexFlow: 'column', alignItems: 'center'}}>
                    ...
                    <span style={{color: '#104879', fontWeight:'bold'}}>balance as of:</span>
